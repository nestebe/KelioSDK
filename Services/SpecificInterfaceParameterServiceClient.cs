...
namespace KelioSDK.Services
{
  public class SpecificInterfaceParameterServiceClient
  {
    ...
    {
      return Client.Post<ExportSpecificInterfaceParameters, ExportSpecificInterfaceParametersResponse>(this.username, this.password, this.baseuri, "SpecificInterfaceParameterService", arg, this.timeoutSeconds);
    }

    public Task<ExportSpecificInterfaceParametersResponse> ExportSpecificInterfaceParametersAsync(
      ExportSpecificInterfaceParameters arg)
    {
      return Client.PostAsync<ExportSpecificInterfaceParameters, ExportSpecificInterfaceParametersResponse>(this.username, this.password, this.baseuri, "SpecificInterfaceParameterService", arg, this.timeoutSeconds);
    }
  }
}
