...
namespace KelioSDK.Services
{
    public class OperatingDataValueServiceClient
    {
        ...
        {
            return Client.Post<ExportOperatingDataValue, ExportOperatingDataValueResponse>(this.username, this.password,
                this.baseuri, "OperatingDataValueService", arg, this.timeoutSeconds);
        }

        public Task<ExportOperatingDataValueResponse> ExportOperatingDataValueAsync(
            ExportOperatingDataValue arg)
        {
            return Client.PostAsync<ExportOperatingDataValue, ExportOperatingDataValueResponse>(this.username,
                this.password, this.baseuri, "OperatingDataValueService", arg, this.timeoutSeconds);
        }

        public ImportOperatingDataValueResponse ImportOperatingDataValue(
            ImportOperatingDataValue arg)
        {
            return Client.Post<ImportOperatingDataValue, ImportOperatingDataValueResponse>(this.username, this.password,
                this.baseuri, "OperatingDataValueService", arg, this.timeoutSeconds);
        }
        ...
        public Task<ImportOperatingDataValueResponse> ImportOperatingDataValueAsync(
            ImportOperatingDataValue arg)
        {
            return Client.PostAsync<ImportOperatingDataValue, ImportOperatingDataValueResponse>(this.username,
                this.password, this.baseuri, "OperatingDataValueService", arg, this.timeoutSeconds);
        }
    }
}