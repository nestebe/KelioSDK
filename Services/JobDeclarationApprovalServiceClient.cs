...
namespace KelioSDK.Services
{
    public class JobDeclarationApprovalServiceClient
    {
        ...
        {
            return Client.Post<ExportJobDeclarationApprovals, ExportJobDeclarationApprovalsResponse>(this.username,
                this.password, this.baseuri, "JobDeclarationApprovalService", arg, this.timeoutSeconds);
        }

        public Task<ExportJobDeclarationApprovalsResponse> ExportJobDeclarationApprovalsAsync(
            ExportJobDeclarationApprovals arg)
        {
            return Client.PostAsync<ExportJobDeclarationApprovals, ExportJobDeclarationApprovalsResponse>(this.username,
                this.password, this.baseuri, "JobDeclarationApprovalService", arg, this.timeoutSeconds);
        }
        ...
        {
            return Client.Post<ImportJobDeclarationApprovals, ImportJobDeclarationApprovalsResponse>(this.username,
                this.password, this.baseuri, "JobDeclarationApprovalService", arg, this.timeoutSeconds);
        }
        ...
        public Task<ImportJobDeclarationApprovalsResponse> ImportJobDeclarationApprovalsAsync(
            ImportJobDeclarationApprovals arg)
        {
            return Client.PostAsync<ImportJobDeclarationApprovals, ImportJobDeclarationApprovalsResponse>(this.username,
                this.password, this.baseuri, "JobDeclarationApprovalService", arg, this.timeoutSeconds);
        }
    }
}