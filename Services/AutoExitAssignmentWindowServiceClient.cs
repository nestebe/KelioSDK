...
namespace KelioSDK.Services
{
    public class AutoExitAssignmentWindowServiceClient
    {
        ...
        {
            return Client.Post<ExportAutoExitAssignmentWindows, ExportAutoExitAssignmentWindowsResponse>(this.username,
                this.password, this.baseuri, "AutoExitAssignmentWindowService", arg, this.timeoutSeconds);
        }

        public Task<ExportAutoExitAssignmentWindowsResponse> ExportAutoExitAssignmentWindowsAsync(
            ExportAutoExitAssignmentWindows arg)
        {
            return Client.PostAsync<ExportAutoExitAssignmentWindows, ExportAutoExitAssignmentWindowsResponse>(
                this.username, this.password, this.baseuri, "AutoExitAssignmentWindowService", arg,
                this.timeoutSeconds);
        }
        ...
        {
            return Client.Post<ExportAutoExitAssignmentWindowsList, ExportAutoExitAssignmentWindowsListResponse>(
                this.username, this.password, this.baseuri, "AutoExitAssignmentWindowService", arg,
                this.timeoutSeconds);
        }
        ...
        public Task<ExportAutoExitAssignmentWindowsListResponse> ExportAutoExitAssignmentWindowsListAsync(
            ExportAutoExitAssignmentWindowsList arg)
        {
            return Client.PostAsync<ExportAutoExitAssignmentWindowsList, ExportAutoExitAssignmentWindowsListResponse>(
                this.username, this.password, this.baseuri, "AutoExitAssignmentWindowService", arg,
                this.timeoutSeconds);
        }
        ...
        {
            return Client.Post<ImportAutoExitAssignmentWindows, ImportAutoExitAssignmentWindowsResponse>(this.username,
                this.password, this.baseuri, "AutoExitAssignmentWindowService", arg, this.timeoutSeconds);
        }
        ...
        public Task<ImportAutoExitAssignmentWindowsResponse> ImportAutoExitAssignmentWindowsAsync(
            ImportAutoExitAssignmentWindows arg)
        {
            return Client.PostAsync<ImportAutoExitAssignmentWindows, ImportAutoExitAssignmentWindowsResponse>(
                this.username, this.password, this.baseuri, "AutoExitAssignmentWindowService", arg,
                this.timeoutSeconds);
        }
    }
