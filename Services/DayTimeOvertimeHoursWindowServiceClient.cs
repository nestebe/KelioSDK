...
namespace KelioSDK.Services
{
    public class DayTimeOvertimeHoursWindowServiceClient
    {
        ...
        {
            return Client.Post<ImportDayTimeOvertimeHoursWindows, ImportDayTimeOvertimeHoursWindowsResponse>(
                this.username, this.password, this.baseuri, "DayTimeOvertimeHoursWindowService", arg,
                this.timeoutSeconds);
        }
        ...
        public Task<ImportDayTimeOvertimeHoursWindowsResponse> ImportDayTimeOvertimeHoursWindowsAsync(
            ImportDayTimeOvertimeHoursWindows arg)
        {
            return Client.PostAsync<ImportDayTimeOvertimeHoursWindows, ImportDayTimeOvertimeHoursWindowsResponse>(
                this.username, this.password, this.baseuri, "DayTimeOvertimeHoursWindowService", arg,
                this.timeoutSeconds);
        }
        ...
        {
            return Client.Post<ExportDayTimeOvertimeHoursWindowsList, ExportDayTimeOvertimeHoursWindowsListResponse>(
                this.username, this.password, this.baseuri, "DayTimeOvertimeHoursWindowService", arg,
                this.timeoutSeconds);
        }
        ...
        {
            return Client
                .PostAsync<ExportDayTimeOvertimeHoursWindowsList, ExportDayTimeOvertimeHoursWindowsListResponse>(
                    this.username, this.password, this.baseuri, "DayTimeOvertimeHoursWindowService", arg,
                    this.timeoutSeconds);
        }
        ...
        {
            return Client.Post<ExportDayTimeOvertimeHoursWindows, ExportDayTimeOvertimeHoursWindowsResponse>(
                this.username, this.password, this.baseuri, "DayTimeOvertimeHoursWindowService", arg,
                this.timeoutSeconds);
        }
        ...
        public Task<ExportDayTimeOvertimeHoursWindowsResponse> ExportDayTimeOvertimeHoursWindowsAsync(
            ExportDayTimeOvertimeHoursWindows arg)
        {
            return Client.PostAsync<ExportDayTimeOvertimeHoursWindows, ExportDayTimeOvertimeHoursWindowsResponse>(
                this.username, this.password, this.baseuri, "DayTimeOvertimeHoursWindowService", arg,
                this.timeoutSeconds);
        }
    }
