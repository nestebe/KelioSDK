...
namespace KelioSDK.Services
{
    public class SectionAssignmentDayPerDayServiceClient
    {
        ...
        {
            return Client.Post<ExportSectionAssignmentsDayPerDay, ExportSectionAssignmentsDayPerDayResponse>(
                this.username, this.password, this.baseuri, "SectionAssignmentDayPerDayService", arg,
                this.timeoutSeconds);
        }
        ...
        public Task<ExportSectionAssignmentsDayPerDayResponse> ExportSectionAssignmentsDayPerDayAsync(
            ExportSectionAssignmentsDayPerDay arg)
        {
            return Client.PostAsync<ExportSectionAssignmentsDayPerDay, ExportSectionAssignmentsDayPerDayResponse>(
                this.username, this.password, this.baseuri, "SectionAssignmentDayPerDayService", arg,
                this.timeoutSeconds);
        }
        ...
        {
            return Client.Post<ExportSectionAssignmentsDayPerDayList, ExportSectionAssignmentsDayPerDayListResponse>(
                this.username, this.password, this.baseuri, "SectionAssignmentDayPerDayService", arg,
                this.timeoutSeconds);
        }
        ...
        {
            return Client
                .PostAsync<ExportSectionAssignmentsDayPerDayList, ExportSectionAssignmentsDayPerDayListResponse>(
                    this.username, this.password, this.baseuri, "SectionAssignmentDayPerDayService", arg,
                    this.timeoutSeconds);
        }
    }
