...
namespace KelioSDK.Services
{
    public class CostCentreHourlyRateAssignmentServiceClient
    {
        ...
        {
            return Client.Post<ExportCostCentreHourlyRateAssignments, ExportCostCentreHourlyRateAssignmentsResponse>(
                this.username, this.password, this.baseuri, "CostCentreHourlyRateAssignmentService", arg,
                this.timeoutSeconds);
        }
        ...
        {
            return Client
                .PostAsync<ExportCostCentreHourlyRateAssignments, ExportCostCentreHourlyRateAssignmentsResponse>(
                    this.username, this.password, this.baseuri, "CostCentreHourlyRateAssignmentService", arg,
                    this.timeoutSeconds);
        }
        ...
        {
            return Client
                .Post<ExportCostCentreHourlyRateAssignmentsList, ExportCostCentreHourlyRateAssignmentsListResponse>(
                    this.username, this.password, this.baseuri, "CostCentreHourlyRateAssignmentService", arg,
                    this.timeoutSeconds);
        }
        ...
        {
            return Client
                .PostAsync<ExportCostCentreHourlyRateAssignmentsList,
                    ExportCostCentreHourlyRateAssignmentsListResponse>(this.username, this.password, this.baseuri,
                    "CostCentreHourlyRateAssignmentService", arg, this.timeoutSeconds);
        }
        ...
        {
            return Client.Post<ImportCostCentreHourlyRateAssignments, ImportCostCentreHourlyRateAssignmentsResponse>(
                this.username, this.password, this.baseuri, "CostCentreHourlyRateAssignmentService", arg,
                this.timeoutSeconds);
        }
        ...
        {
            return Client
                .PostAsync<ImportCostCentreHourlyRateAssignments, ImportCostCentreHourlyRateAssignmentsResponse>(
                    this.username, this.password, this.baseuri, "CostCentreHourlyRateAssignmentService", arg,
                    this.timeoutSeconds);
        }
    }
