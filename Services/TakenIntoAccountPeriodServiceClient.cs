...
namespace KelioSDK.Services
{
    public class TakenIntoAccountPeriodServiceClient
    {
        ...
        {
            return Client.Post<ExportTakenIntoAccountPeriodsList, ExportTakenIntoAccountPeriodsListResponse>(
                this.username, this.password, this.baseuri, "TakenIntoAccountPeriodService", arg, this.timeoutSeconds);
        }

        public Task<ExportTakenIntoAccountPeriodsListResponse> ExportTakenIntoAccountPeriodsListAsync(
            ExportTakenIntoAccountPeriodsList arg)
        {
            return Client.PostAsync<ExportTakenIntoAccountPeriodsList, ExportTakenIntoAccountPeriodsListResponse>(
                this.username, this.password, this.baseuri, "TakenIntoAccountPeriodService", arg, this.timeoutSeconds);
        }
        ...
        {
            return Client.Post<DeleteTakenIntoAccountPeriods, DeleteTakenIntoAccountPeriodsResponse>(this.username,
                this.password, this.baseuri, "TakenIntoAccountPeriodService", arg, this.timeoutSeconds);
        }

        public Task<DeleteTakenIntoAccountPeriodsResponse> DeleteTakenIntoAccountPeriodsAsync(
            DeleteTakenIntoAccountPeriods arg)
        {
            return Client.PostAsync<DeleteTakenIntoAccountPeriods, DeleteTakenIntoAccountPeriodsResponse>(this.username,
                this.password, this.baseuri, "TakenIntoAccountPeriodService", arg, this.timeoutSeconds);
        }
        ...
        {
            return Client.Post<ExportTakenIntoAccountPeriods, ExportTakenIntoAccountPeriodsResponse>(this.username,
                this.password, this.baseuri, "TakenIntoAccountPeriodService", arg, this.timeoutSeconds);
        }
        ...
        public Task<ExportTakenIntoAccountPeriodsResponse> ExportTakenIntoAccountPeriodsAsync(
            ExportTakenIntoAccountPeriods arg)
        {
            return Client.PostAsync<ExportTakenIntoAccountPeriods, ExportTakenIntoAccountPeriodsResponse>(this.username,
                this.password, this.baseuri, "TakenIntoAccountPeriodService", arg, this.timeoutSeconds);
        }
        ...
        {
            return Client.Post<ImportTakenIntoAccountPeriods, ImportTakenIntoAccountPeriodsResponse>(this.username,
                this.password, this.baseuri, "TakenIntoAccountPeriodService", arg, this.timeoutSeconds);
        }
        ...
        public Task<ImportTakenIntoAccountPeriodsResponse> ImportTakenIntoAccountPeriodsAsync(
            ImportTakenIntoAccountPeriods arg)
        {
            return Client.PostAsync<ImportTakenIntoAccountPeriods, ImportTakenIntoAccountPeriodsResponse>(this.username,
                this.password, this.baseuri, "TakenIntoAccountPeriodService", arg, this.timeoutSeconds);
        }
    }
}