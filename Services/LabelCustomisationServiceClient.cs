...
namespace KelioSDK.Services
{
    public class LabelCustomisationServiceClient
    {
        ...
        {
            return Client.Post<ExportLabelCustomisation, ExportLabelCustomisationResponse>(this.username, this.password,
                this.baseuri, "LabelCustomisationService", arg, this.timeoutSeconds);
        }

        public Task<ExportLabelCustomisationResponse> ExportLabelCustomisationAsync(
            ExportLabelCustomisation arg)
        {
            return Client.PostAsync<ExportLabelCustomisation, ExportLabelCustomisationResponse>(this.username,
                this.password, this.baseuri, "LabelCustomisationService", arg, this.timeoutSeconds);
        }
    }
}