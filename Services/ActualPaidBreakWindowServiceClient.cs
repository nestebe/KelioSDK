...
namespace KelioSDK.Services
{
    public class ActualPaidBreakWindowServiceClient
    {
        ...
        {
            return Client.Post<ImportActualPaidBreakWindows, ImportActualPaidBreakWindowsResponse>(this.username,
                this.password, this.baseuri, "ActualPaidBreakWindowService", arg, this.timeoutSeconds);
        }

        public Task<ImportActualPaidBreakWindowsResponse> ImportActualPaidBreakWindowsAsync(
            ImportActualPaidBreakWindows arg)
        {
            return Client.PostAsync<ImportActualPaidBreakWindows, ImportActualPaidBreakWindowsResponse>(this.username,
                this.password, this.baseuri, "ActualPaidBreakWindowService", arg, this.timeoutSeconds);
        }
        ...
        {
            return Client.Post<ExportActualPaidBreakWindowsList, ExportActualPaidBreakWindowsListResponse>(
                this.username, this.password, this.baseuri, "ActualPaidBreakWindowService", arg, this.timeoutSeconds);
        }

        public Task<ExportActualPaidBreakWindowsListResponse> ExportActualPaidBreakWindowsListAsync(
            ExportActualPaidBreakWindowsList arg)
        {
            return Client.PostAsync<ExportActualPaidBreakWindowsList, ExportActualPaidBreakWindowsListResponse>(
                this.username, this.password, this.baseuri, "ActualPaidBreakWindowService", arg, this.timeoutSeconds);
        }
        ...
        {
            return Client.Post<ExportActualPaidBreakWindows, ExportActualPaidBreakWindowsResponse>(this.username,
                this.password, this.baseuri, "ActualPaidBreakWindowService", arg, this.timeoutSeconds);
        }
        ...
        public Task<ExportActualPaidBreakWindowsResponse> ExportActualPaidBreakWindowsAsync(
            ExportActualPaidBreakWindows arg)
        {
            return Client.PostAsync<ExportActualPaidBreakWindows, ExportActualPaidBreakWindowsResponse>(this.username,
                this.password, this.baseuri, "ActualPaidBreakWindowService", arg, this.timeoutSeconds);
        }
    }
}