...
namespace KelioSDK.Services
{
    public class NonActualPaidBreakWindowServiceClient
    {
        ...
        {
            return Client.Post<ExportNonActualPaidBreakWindows, ExportNonActualPaidBreakWindowsResponse>(this.username,
                this.password, this.baseuri, "NonActualPaidBreakWindowService", arg, this.timeoutSeconds);
        }

        public Task<ExportNonActualPaidBreakWindowsResponse> ExportNonActualPaidBreakWindowsAsync(
            ExportNonActualPaidBreakWindows arg)
        {
            return Client.PostAsync<ExportNonActualPaidBreakWindows, ExportNonActualPaidBreakWindowsResponse>(
                this.username, this.password, this.baseuri, "NonActualPaidBreakWindowService", arg,
                this.timeoutSeconds);
        }
        ...
        {
            return Client.Post<ExportNonActualPaidBreakWindowsList, ExportNonActualPaidBreakWindowsListResponse>(
                this.username, this.password, this.baseuri, "NonActualPaidBreakWindowService", arg,
                this.timeoutSeconds);
        }
        ...
        public Task<ExportNonActualPaidBreakWindowsListResponse> ExportNonActualPaidBreakWindowsListAsync(
            ExportNonActualPaidBreakWindowsList arg)
        {
            return Client.PostAsync<ExportNonActualPaidBreakWindowsList, ExportNonActualPaidBreakWindowsListResponse>(
                this.username, this.password, this.baseuri, "NonActualPaidBreakWindowService", arg,
                this.timeoutSeconds);
        }
        ...
        {
            return Client.Post<ImportNonActualPaidBreakWindows, ImportNonActualPaidBreakWindowsResponse>(this.username,
                this.password, this.baseuri, "NonActualPaidBreakWindowService", arg, this.timeoutSeconds);
        }
        ...
        public Task<ImportNonActualPaidBreakWindowsResponse> ImportNonActualPaidBreakWindowsAsync(
            ImportNonActualPaidBreakWindows arg)
        {
            return Client.PostAsync<ImportNonActualPaidBreakWindows, ImportNonActualPaidBreakWindowsResponse>(
                this.username, this.password, this.baseuri, "NonActualPaidBreakWindowService", arg,
                this.timeoutSeconds);
        }
    }
