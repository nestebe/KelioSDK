...
namespace KelioSDK.Services
{
    public class AccountTypeAuthorizationServiceClient
    {
        ...
        {
            return Client
                .Post<ExportSpecialHourTypeAuthorizationsList, ExportSpecialHourTypeAuthorizationsListResponse>(
                    this.username, this.password, this.baseuri, "AccountTypeAuthorizationService", arg,
                    this.timeoutSeconds);
        }
        ...
        {
            return Client
                .PostAsync<ExportSpecialHourTypeAuthorizationsList, ExportSpecialHourTypeAuthorizationsListResponse>(
                    this.username, this.password, this.baseuri, "AccountTypeAuthorizationService", arg,
                    this.timeoutSeconds);
        }
        ...
        {
            return Client.Post<ExportSpecialHourTypeAuthorizations, ExportSpecialHourTypeAuthorizationsResponse>(
                this.username, this.password, this.baseuri, "AccountTypeAuthorizationService", arg,
                this.timeoutSeconds);
        }
        ...
        public Task<ExportSpecialHourTypeAuthorizationsResponse> ExportSpecialHourTypeAuthorizationsAsync(
            ExportSpecialHourTypeAuthorizations arg)
        {
            return Client.PostAsync<ExportSpecialHourTypeAuthorizations, ExportSpecialHourTypeAuthorizationsResponse>(
                this.username, this.password, this.baseuri, "AccountTypeAuthorizationService", arg,
                this.timeoutSeconds);
        }
        ...
        {
            return Client.Post<ImportOvertimeHourTypeAuthorizations, ImportOvertimeHourTypeAuthorizationsResponse>(
                this.username, this.password, this.baseuri, "AccountTypeAuthorizationService", arg,
                this.timeoutSeconds);
        }
        ...
        public Task<ImportOvertimeHourTypeAuthorizationsResponse> ImportOvertimeHourTypeAuthorizationsAsync(
            ImportOvertimeHourTypeAuthorizations arg)
        {
            return Client.PostAsync<ImportOvertimeHourTypeAuthorizations, ImportOvertimeHourTypeAuthorizationsResponse>(
                this.username, this.password, this.baseuri, "AccountTypeAuthorizationService", arg,
                this.timeoutSeconds);
        }
        ...
        {
            return Client.Post<DeleteSpecialHourTypeAuthorizations, DeleteSpecialHourTypeAuthorizationsResponse>(
                this.username, this.password, this.baseuri, "AccountTypeAuthorizationService", arg,
                this.timeoutSeconds);
        }
        ...
        public Task<DeleteSpecialHourTypeAuthorizationsResponse> DeleteSpecialHourTypeAuthorizationsAsync(
            DeleteSpecialHourTypeAuthorizations arg)
        {
            return Client.PostAsync<DeleteSpecialHourTypeAuthorizations, DeleteSpecialHourTypeAuthorizationsResponse>(
                this.username, this.password, this.baseuri, "AccountTypeAuthorizationService", arg,
                this.timeoutSeconds);
        }
        ...
        {
            return Client
                .Post<ExportOvertimeHourTypeAuthorizationsList, ExportOvertimeHourTypeAuthorizationsListResponse>(
                    this.username, this.password, this.baseuri, "AccountTypeAuthorizationService", arg,
                    this.timeoutSeconds);
        }
        ...
        {
            return Client
                .PostAsync<ExportOvertimeHourTypeAuthorizationsList, ExportOvertimeHourTypeAuthorizationsListResponse>(
                    this.username, this.password, this.baseuri, "AccountTypeAuthorizationService", arg,
                    this.timeoutSeconds);
        }
        ...
        {
            return Client.Post<ExportOvertimeHourTypeAuthorizations, ExportOvertimeHourTypeAuthorizationsResponse>(
                this.username, this.password, this.baseuri, "AccountTypeAuthorizationService", arg,
                this.timeoutSeconds);
        }
        ...
        public Task<ExportOvertimeHourTypeAuthorizationsResponse> ExportOvertimeHourTypeAuthorizationsAsync(
            ExportOvertimeHourTypeAuthorizations arg)
        {
            return Client.PostAsync<ExportOvertimeHourTypeAuthorizations, ExportOvertimeHourTypeAuthorizationsResponse>(
                this.username, this.password, this.baseuri, "AccountTypeAuthorizationService", arg,
                this.timeoutSeconds);
        }
        ...
        {
            return Client.Post<ImportSpecialHourTypeAuthorizations, ImportSpecialHourTypeAuthorizationsResponse>(
                this.username, this.password, this.baseuri, "AccountTypeAuthorizationService", arg,
                this.timeoutSeconds);
        }
        ...
        public Task<ImportSpecialHourTypeAuthorizationsResponse> ImportSpecialHourTypeAuthorizationsAsync(
            ImportSpecialHourTypeAuthorizations arg)
        {
            return Client.PostAsync<ImportSpecialHourTypeAuthorizations, ImportSpecialHourTypeAuthorizationsResponse>(
                this.username, this.password, this.baseuri, "AccountTypeAuthorizationService", arg,
                this.timeoutSeconds);
        }
        ...
        {
            return Client.Post<DeleteOvertimeHourTypeAuthorizations, DeleteOvertimeHourTypeAuthorizationsResponse>(
                this.username, this.password, this.baseuri, "AccountTypeAuthorizationService", arg,
                this.timeoutSeconds);
        }
        ...
        public Task<DeleteOvertimeHourTypeAuthorizationsResponse> DeleteOvertimeHourTypeAuthorizationsAsync(
            DeleteOvertimeHourTypeAuthorizations arg)
        {
            return Client.PostAsync<DeleteOvertimeHourTypeAuthorizations, DeleteOvertimeHourTypeAuthorizationsResponse>(
                this.username, this.password, this.baseuri, "AccountTypeAuthorizationService", arg,
                this.timeoutSeconds);
        }
        ...
        {
            return Client.Post<ExportBonusTypeAuthorizations, ExportBonusTypeAuthorizationsResponse>(this.username,
                this.password, this.baseuri, "AccountTypeAuthorizationService", arg, this.timeoutSeconds);
        }

        public Task<ExportBonusTypeAuthorizationsResponse> ExportBonusTypeAuthorizationsAsync(
            ExportBonusTypeAuthorizations arg)
        {
            return Client.PostAsync<ExportBonusTypeAuthorizations, ExportBonusTypeAuthorizationsResponse>(this.username,
                this.password, this.baseuri, "AccountTypeAuthorizationService", arg, this.timeoutSeconds);
        }
        ...
        {
            return Client.Post<ExportBonusTypeAuthorizationsList, ExportBonusTypeAuthorizationsListResponse>(
                this.username, this.password, this.baseuri, "AccountTypeAuthorizationService", arg,
                this.timeoutSeconds);
        }
        ...
        public Task<ExportBonusTypeAuthorizationsListResponse> ExportBonusTypeAuthorizationsListAsync(
            ExportBonusTypeAuthorizationsList arg)
        {
            return Client.PostAsync<ExportBonusTypeAuthorizationsList, ExportBonusTypeAuthorizationsListResponse>(
                this.username, this.password, this.baseuri, "AccountTypeAuthorizationService", arg,
                this.timeoutSeconds);
        }
        ...
        {
            return Client.Post<ImportBonusTypeAuthorizations, ImportBonusTypeAuthorizationsResponse>(this.username,
                this.password, this.baseuri, "AccountTypeAuthorizationService", arg, this.timeoutSeconds);
        }
        ...
        public Task<ImportBonusTypeAuthorizationsResponse> ImportBonusTypeAuthorizationsAsync(
            ImportBonusTypeAuthorizations arg)
        {
            return Client.PostAsync<ImportBonusTypeAuthorizations, ImportBonusTypeAuthorizationsResponse>(this.username,
                this.password, this.baseuri, "AccountTypeAuthorizationService", arg, this.timeoutSeconds);
        }
        ...
        {
            return Client.Post<DeleteBonusTypeAuthorizations, DeleteBonusTypeAuthorizationsResponse>(this.username,
                this.password, this.baseuri, "AccountTypeAuthorizationService", arg, this.timeoutSeconds);
        }
        ...
        public Task<DeleteBonusTypeAuthorizationsResponse> DeleteBonusTypeAuthorizationsAsync(
            DeleteBonusTypeAuthorizations arg)
        {
            return Client.PostAsync<DeleteBonusTypeAuthorizations, DeleteBonusTypeAuthorizationsResponse>(this.username,
                this.password, this.baseuri, "AccountTypeAuthorizationService", arg, this.timeoutSeconds);
        }
    }
}