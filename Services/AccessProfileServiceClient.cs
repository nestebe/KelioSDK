...
namespace KelioSDK.Services
{
    public class AccessProfileServiceClient
    {
        ...
        {
            return Client.Post<ExportAccessProfiles, ExportAccessProfilesResponse>(this.username, this.password,
                this.baseuri, "AccessProfileService", arg, this.timeoutSeconds);
        }

        public Task<ExportAccessProfilesResponse> ExportAccessProfilesAsync(
            ExportAccessProfiles arg)
        {
            return Client.PostAsync<ExportAccessProfiles, ExportAccessProfilesResponse>(this.username, this.password,
                this.baseuri, "AccessProfileService", arg, this.timeoutSeconds);
        }
        ...
        {
            return Client.Post<ImportAccessProfiles, ImportAccessProfilesResponse>(this.username, this.password,
                this.baseuri, "AccessProfileService", arg, this.timeoutSeconds);
        }
        ...
        public Task<ImportAccessProfilesResponse> ImportAccessProfilesAsync(
            ImportAccessProfiles arg)
        {
            return Client.PostAsync<ImportAccessProfiles, ImportAccessProfilesResponse>(this.username, this.password,
                this.baseuri, "AccessProfileService", arg, this.timeoutSeconds);
        }
    }
}