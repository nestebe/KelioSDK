...
{
  [XmlType(Namespace = "http://echange.service.open.bodet.com", TypeName = "exportCalculationFunctionExecutionsFromRelativeDates")]
  public class ExportCalculationFunctionExecutionsFromRelativeDates
  {
    ...
    [XmlElement(DataType = "short", ElementName = "functionType", IsNullable = true, Order = 4)]
