...
namespace KelioSDK.Services
{
    public class CalculationRuleWindowServiceClient
    {
        ...
        {
            return Client.Post<ExportCalculationRuleWindows, ExportCalculationRuleWindowsResponse>(this.username,
                this.password, this.baseuri, "CalculationRuleWindowService", arg, this.timeoutSeconds);
        }

        public Task<ExportCalculationRuleWindowsResponse> ExportCalculationRuleWindowsAsync(
            ExportCalculationRuleWindows arg)
        {
            return Client.PostAsync<ExportCalculationRuleWindows, ExportCalculationRuleWindowsResponse>(this.username,
                this.password, this.baseuri, "CalculationRuleWindowService", arg, this.timeoutSeconds);
        }
        ...
        {
            return Client.Post<ExportCalculationRuleWindowsList, ExportCalculationRuleWindowsListResponse>(
                this.username, this.password, this.baseuri, "CalculationRuleWindowService", arg, this.timeoutSeconds);
        }

        public Task<ExportCalculationRuleWindowsListResponse> ExportCalculationRuleWindowsListAsync(
            ExportCalculationRuleWindowsList arg)
        {
            return Client.PostAsync<ExportCalculationRuleWindowsList, ExportCalculationRuleWindowsListResponse>(
                this.username, this.password, this.baseuri, "CalculationRuleWindowService", arg, this.timeoutSeconds);
        }
        ...
        {
            return Client.Post<ImportCalculationRuleWindows, ImportCalculationRuleWindowsResponse>(this.username,
                this.password, this.baseuri, "CalculationRuleWindowService", arg, this.timeoutSeconds);
        }
        ...
        public Task<ImportCalculationRuleWindowsResponse> ImportCalculationRuleWindowsAsync(
            ImportCalculationRuleWindows arg)
        {
            return Client.PostAsync<ImportCalculationRuleWindows, ImportCalculationRuleWindowsResponse>(this.username,
                this.password, this.baseuri, "CalculationRuleWindowService", arg, this.timeoutSeconds);
        }
    }
}