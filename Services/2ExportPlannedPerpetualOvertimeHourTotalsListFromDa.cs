...
{
  [XmlType(Namespace = "http://echange.service.open.bodet.com", TypeName = "exportPlannedPerpetualOvertimeHourTotalsListFromDate")]
  public class ExportPlannedPerpetualOvertimeHourTotalsListFromDate
  {
