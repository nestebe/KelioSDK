...
namespace KelioSDK.Services
{
    public class JobDeclarationServiceClient
    {
        ...
        {
            return Client.Post<ExportJobDeclarationsList, ExportJobDeclarationsListResponse>(this.username,
                this.password, this.baseuri, "JobDeclarationService", arg, this.timeoutSeconds);
        }

        public Task<ExportJobDeclarationsListResponse> ExportJobDeclarationsListAsync(
            ExportJobDeclarationsList arg)
        {
            return Client.PostAsync<ExportJobDeclarationsList, ExportJobDeclarationsListResponse>(this.username,
                this.password, this.baseuri, "JobDeclarationService", arg, this.timeoutSeconds);
        }
    }
}