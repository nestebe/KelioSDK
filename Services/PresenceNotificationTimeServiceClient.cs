...
namespace KelioSDK.Services
{
    public class PresenceNotificationTimeServiceClient
    {
        ...
        {
            return Client.Post<DeletePresenceNotificationTime, DeletePresenceNotificationTimeResponse>(this.username,
                this.password, this.baseuri, "PresenceNotificationTimeService", arg, this.timeoutSeconds);
        }

        public Task<DeletePresenceNotificationTimeResponse> DeletePresenceNotificationTimeAsync(
            DeletePresenceNotificationTime arg)
        {
            return Client.PostAsync<DeletePresenceNotificationTime, DeletePresenceNotificationTimeResponse>(
                this.username, this.password, this.baseuri, "PresenceNotificationTimeService", arg,
                this.timeoutSeconds);
        }
        ...
        {
            return Client.Post<ImportPresenceNotificationTime, ImportPresenceNotificationTimeResponse>(this.username,
                this.password, this.baseuri, "PresenceNotificationTimeService", arg, this.timeoutSeconds);
        }
        ...
        public Task<ImportPresenceNotificationTimeResponse> ImportPresenceNotificationTimeAsync(
            ImportPresenceNotificationTime arg)
        {
            return Client.PostAsync<ImportPresenceNotificationTime, ImportPresenceNotificationTimeResponse>(
                this.username, this.password, this.baseuri, "PresenceNotificationTimeService", arg,
                this.timeoutSeconds);
        }
        ...
        {
            return Client.Post<ExportPresenceNotificationTime, ExportPresenceNotificationTimeResponse>(this.username,
                this.password, this.baseuri, "PresenceNotificationTimeService", arg, this.timeoutSeconds);
        }
        ...
        public Task<ExportPresenceNotificationTimeResponse> ExportPresenceNotificationTimeAsync(
            ExportPresenceNotificationTime arg)
        {
            return Client.PostAsync<ExportPresenceNotificationTime, ExportPresenceNotificationTimeResponse>(
                this.username, this.password, this.baseuri, "PresenceNotificationTimeService", arg,
                this.timeoutSeconds);
        }
    }
