...
namespace KelioSDK.Services
{
    public class ToleranceWindowServiceClient
    {
        ...
        {
            return Client.Post<ImportToleranceWindows, ImportToleranceWindowsResponse>(this.username, this.password,
                this.baseuri, "ToleranceWindowService", arg, this.timeoutSeconds);
        }

        public Task<ImportToleranceWindowsResponse> ImportToleranceWindowsAsync(
            ImportToleranceWindows arg)
        {
            return Client.PostAsync<ImportToleranceWindows, ImportToleranceWindowsResponse>(this.username,
                this.password, this.baseuri, "ToleranceWindowService", arg, this.timeoutSeconds);
        }

        public ExportToleranceWindowsListResponse ExportToleranceWindowsList(
            ExportToleranceWindowsList arg)
        {
            return Client.Post<ExportToleranceWindowsList, ExportToleranceWindowsListResponse>(this.username,
                this.password, this.baseuri, "ToleranceWindowService", arg, this.timeoutSeconds);
        }
        ...
        public Task<ExportToleranceWindowsListResponse> ExportToleranceWindowsListAsync(
            ExportToleranceWindowsList arg)
        {
            return Client.PostAsync<ExportToleranceWindowsList, ExportToleranceWindowsListResponse>(this.username,
                this.password, this.baseuri, "ToleranceWindowService", arg, this.timeoutSeconds);
        }
        ...
        {
            return Client.Post<ExportToleranceWindows, ExportToleranceWindowsResponse>(this.username, this.password,
                this.baseuri, "ToleranceWindowService", arg, this.timeoutSeconds);
        }
        ...
        public Task<ExportToleranceWindowsResponse> ExportToleranceWindowsAsync(
            ExportToleranceWindows arg)
        {
            return Client.PostAsync<ExportToleranceWindows, ExportToleranceWindowsResponse>(this.username,
                this.password, this.baseuri, "ToleranceWindowService", arg, this.timeoutSeconds);
        }
    }
}