...
{
  [XmlType(Namespace = "http://echange.service.open.bodet.com", TypeName = "exportStandardHoursWindows")]
  public class ExportStandardHoursWindows
  {
