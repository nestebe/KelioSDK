...
namespace KelioSDK.Services
{
    public class MedicalAppointmentServiceClient
    {
        ...
        {
            return Client.Post<DeleteMedicalAppointments, DeleteMedicalAppointmentsResponse>(this.username,
                this.password, this.baseuri, "MedicalAppointmentService", arg, this.timeoutSeconds);
        }

        public Task<DeleteMedicalAppointmentsResponse> DeleteMedicalAppointmentsAsync(
            DeleteMedicalAppointments arg)
        {
            return Client.PostAsync<DeleteMedicalAppointments, DeleteMedicalAppointmentsResponse>(this.username,
                this.password, this.baseuri, "MedicalAppointmentService", arg, this.timeoutSeconds);
        }
        ...
        {
            return Client.Post<ImportMedicalAppointments, ImportMedicalAppointmentsResponse>(this.username,
                this.password, this.baseuri, "MedicalAppointmentService", arg, this.timeoutSeconds);
        }
        ...
        public Task<ImportMedicalAppointmentsResponse> ImportMedicalAppointmentsAsync(
            ImportMedicalAppointments arg)
        {
            return Client.PostAsync<ImportMedicalAppointments, ImportMedicalAppointmentsResponse>(this.username,
                this.password, this.baseuri, "MedicalAppointmentService", arg, this.timeoutSeconds);
        }
        ...
        {
            return Client.Post<ExportMedicalAppointmentsList, ExportMedicalAppointmentsListResponse>(this.username,
                this.password, this.baseuri, "MedicalAppointmentService", arg, this.timeoutSeconds);
        }
        ...
        public Task<ExportMedicalAppointmentsListResponse> ExportMedicalAppointmentsListAsync(
            ExportMedicalAppointmentsList arg)
        {
            return Client.PostAsync<ExportMedicalAppointmentsList, ExportMedicalAppointmentsListResponse>(this.username,
                this.password, this.baseuri, "MedicalAppointmentService", arg, this.timeoutSeconds);
        }
        ...
        {
            return Client.Post<ExportMedicalAppointments, ExportMedicalAppointmentsResponse>(this.username,
                this.password, this.baseuri, "MedicalAppointmentService", arg, this.timeoutSeconds);
        }
        ...
        public Task<ExportMedicalAppointmentsResponse> ExportMedicalAppointmentsAsync(
            ExportMedicalAppointments arg)
        {
            return Client.PostAsync<ExportMedicalAppointments, ExportMedicalAppointmentsResponse>(this.username,
                this.password, this.baseuri, "MedicalAppointmentService", arg, this.timeoutSeconds);
        }
    }
}