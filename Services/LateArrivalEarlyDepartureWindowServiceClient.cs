...
namespace KelioSDK.Services
{
    public class LateArrivalEarlyDepartureWindowServiceClient
    {
        ...
        {
            return Client.Post<ExportLateArrivalEarlyDepartureWindows, ExportLateArrivalEarlyDepartureWindowsResponse>(
                this.username, this.password, this.baseuri, "LateArrivalEarlyDepartureWindowService", arg,
                this.timeoutSeconds);
        }
        ...
        {
            return Client
                .PostAsync<ExportLateArrivalEarlyDepartureWindows, ExportLateArrivalEarlyDepartureWindowsResponse>(
                    this.username, this.password, this.baseuri, "LateArrivalEarlyDepartureWindowService", arg,
                    this.timeoutSeconds);
        }
        ...
        {
            return Client
                .Post<ExportLateArrivalEarlyDepartureWindowsList, ExportLateArrivalEarlyDepartureWindowsListResponse>(
                    this.username, this.password, this.baseuri, "LateArrivalEarlyDepartureWindowService", arg,
                    this.timeoutSeconds);
        }
        ...
        {
            return Client
                .PostAsync<ExportLateArrivalEarlyDepartureWindowsList,
                    ExportLateArrivalEarlyDepartureWindowsListResponse>(this.username, this.password, this.baseuri,
                    "LateArrivalEarlyDepartureWindowService", arg, this.timeoutSeconds);
        }
        ...
        {
            return Client.Post<ImportLateArrivalEarlyDepartureWindows, ImportLateArrivalEarlyDepartureWindowsResponse>(
                this.username, this.password, this.baseuri, "LateArrivalEarlyDepartureWindowService", arg,
                this.timeoutSeconds);
        }
        ...
        {
            return Client
                .PostAsync<ImportLateArrivalEarlyDepartureWindows, ImportLateArrivalEarlyDepartureWindowsResponse>(
                    this.username, this.password, this.baseuri, "LateArrivalEarlyDepartureWindowService", arg,
                    this.timeoutSeconds);
        }
    }
