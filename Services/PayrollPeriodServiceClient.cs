...
namespace KelioSDK.Services
{
  public class PayrollPeriodServiceClient
  {
    ...
    {
      return Client.Post<ExportPayrollPeriods, ExportPayrollPeriodsResponse>(this.username, this.password, this.baseuri, "PayrollPeriodService", arg, this.timeoutSeconds);
    }

    public Task<ExportPayrollPeriodsResponse> ExportPayrollPeriodsAsync(
      ExportPayrollPeriods arg)
    {
      return Client.PostAsync<ExportPayrollPeriods, ExportPayrollPeriodsResponse>(this.username, this.password, this.baseuri, "PayrollPeriodService", arg, this.timeoutSeconds);
    }
  }
}
