...
namespace KelioSDK.Services
{
    public class IconServiceClient
    {
        ...
        {
            return Client.Post<ExportIcons, ExportIconsResponse>(this.username, this.password, this.baseuri,
                "IconService", arg, this.timeoutSeconds);
        }

        public Task<ExportIconsResponse> ExportIconsAsync(ExportIcons arg)
        {
            return Client.PostAsync<ExportIcons, ExportIconsResponse>(this.username, this.password, this.baseuri,
                "IconService", arg, this.timeoutSeconds);
        }
    }
}