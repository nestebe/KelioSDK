...
namespace KelioSDK.Services
{
    public class JobHourlyRateAssignmentServiceClient
    {
        ...
        {
            return Client.Post<ExportJobHourlyRateAssignmentsList, ExportJobHourlyRateAssignmentsListResponse>(
                this.username, this.password, this.baseuri, "JobHourlyRateAssignmentService", arg, this.timeoutSeconds);
        }

        public Task<ExportJobHourlyRateAssignmentsListResponse> ExportJobHourlyRateAssignmentsListAsync(
            ExportJobHourlyRateAssignmentsList arg)
        {
            return Client.PostAsync<ExportJobHourlyRateAssignmentsList, ExportJobHourlyRateAssignmentsListResponse>(
                this.username, this.password, this.baseuri, "JobHourlyRateAssignmentService", arg, this.timeoutSeconds);
        }
        ...
        {
            return Client.Post<ExportJobHourlyRateAssignments, ExportJobHourlyRateAssignmentsResponse>(this.username,
                this.password, this.baseuri, "JobHourlyRateAssignmentService", arg, this.timeoutSeconds);
        }

        public Task<ExportJobHourlyRateAssignmentsResponse> ExportJobHourlyRateAssignmentsAsync(
            ExportJobHourlyRateAssignments arg)
        {
            return Client.PostAsync<ExportJobHourlyRateAssignments, ExportJobHourlyRateAssignmentsResponse>(
                this.username, this.password, this.baseuri, "JobHourlyRateAssignmentService", arg, this.timeoutSeconds);
        }
        ...
        {
            return Client.Post<ImportJobHourlyRateAssignments, ImportJobHourlyRateAssignmentsResponse>(this.username,
                this.password, this.baseuri, "JobHourlyRateAssignmentService", arg, this.timeoutSeconds);
        }
        ...
        public Task<ImportJobHourlyRateAssignmentsResponse> ImportJobHourlyRateAssignmentsAsync(
            ImportJobHourlyRateAssignments arg)
        {
            return Client.PostAsync<ImportJobHourlyRateAssignments, ImportJobHourlyRateAssignmentsResponse>(
                this.username, this.password, this.baseuri, "JobHourlyRateAssignmentService", arg, this.timeoutSeconds);
        }
    }
}