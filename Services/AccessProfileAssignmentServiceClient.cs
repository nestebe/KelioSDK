...
namespace KelioSDK.Services
{
    public class AccessProfileAssignmentServiceClient
    {
        ...
        {
            return Client.Post<ImportAccessProfileAssignments, ImportAccessProfileAssignmentsResponse>(this.username,
                this.password, this.baseuri, "AccessProfileAssignmentService", arg, this.timeoutSeconds);
        }

        public Task<ImportAccessProfileAssignmentsResponse> ImportAccessProfileAssignmentsAsync(
            ImportAccessProfileAssignments arg)
        {
            return Client.PostAsync<ImportAccessProfileAssignments, ImportAccessProfileAssignmentsResponse>(
                this.username, this.password, this.baseuri, "AccessProfileAssignmentService", arg, this.timeoutSeconds);
        }

        public ExportAccessProfileAssignmentsResponse ExportAccessProfileAssignments(
            ExportAccessProfileAssignments arg)
        {
            return Client.Post<ExportAccessProfileAssignments, ExportAccessProfileAssignmentsResponse>(this.username,
                this.password, this.baseuri, "AccessProfileAssignmentService", arg, this.timeoutSeconds);
        }
        ...
        public Task<ExportAccessProfileAssignmentsResponse> ExportAccessProfileAssignmentsAsync(
            ExportAccessProfileAssignments arg)
        {
            return Client.PostAsync<ExportAccessProfileAssignments, ExportAccessProfileAssignmentsResponse>(
                this.username, this.password, this.baseuri, "AccessProfileAssignmentService", arg, this.timeoutSeconds);
        }
        ...
        {
            return Client.Post<ExportAccessProfileAssignmentsList, ExportAccessProfileAssignmentsListResponse>(
                this.username, this.password, this.baseuri, "AccessProfileAssignmentService", arg, this.timeoutSeconds);
        }
        ...
        public Task<ExportAccessProfileAssignmentsListResponse> ExportAccessProfileAssignmentsListAsync(
            ExportAccessProfileAssignmentsList arg)
        {
            return Client.PostAsync<ExportAccessProfileAssignmentsList, ExportAccessProfileAssignmentsListResponse>(
                this.username, this.password, this.baseuri, "AccessProfileAssignmentService", arg, this.timeoutSeconds);
        }
    }
}