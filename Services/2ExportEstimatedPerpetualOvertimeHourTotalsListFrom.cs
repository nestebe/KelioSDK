...
{
  [XmlType(Namespace = "http://echange.service.open.bodet.com", TypeName = "exportEstimatedPerpetualOvertimeHourTotalsListFromDate")]
  public class ExportEstimatedPerpetualOvertimeHourTotalsListFromDate
  {
