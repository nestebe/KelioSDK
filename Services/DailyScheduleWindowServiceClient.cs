...
namespace KelioSDK.Services
{
    public class DailyScheduleWindowServiceClient
    {
        ...
        {
            return Client.Post<DeleteDailyScheduleWindowsList, DeleteDailyScheduleWindowsListResponse>(this.username,
                this.password, this.baseuri, "DailyScheduleWindowService", arg, this.timeoutSeconds);
        }

        public Task<DeleteDailyScheduleWindowsListResponse> DeleteDailyScheduleWindowsListAsync(
            DeleteDailyScheduleWindowsList arg)
        {
            return Client.PostAsync<DeleteDailyScheduleWindowsList, DeleteDailyScheduleWindowsListResponse>(
                this.username, this.password, this.baseuri, "DailyScheduleWindowService", arg, this.timeoutSeconds);
        }

        public DeleteDailyScheduleWindowsResponse DeleteDailyScheduleWindows(
            DeleteDailyScheduleWindows arg)
        {
            return Client.Post<DeleteDailyScheduleWindows, DeleteDailyScheduleWindowsResponse>(this.username,
                this.password, this.baseuri, "DailyScheduleWindowService", arg, this.timeoutSeconds);
        }
        ...
        public Task<DeleteDailyScheduleWindowsResponse> DeleteDailyScheduleWindowsAsync(
            DeleteDailyScheduleWindows arg)
        {
            return Client.PostAsync<DeleteDailyScheduleWindows, DeleteDailyScheduleWindowsResponse>(this.username,
                this.password, this.baseuri, "DailyScheduleWindowService", arg, this.timeoutSeconds);
        }
        ...
        {
            return Client.Post<ExportDailyScheduleWindowsList, ExportDailyScheduleWindowsListResponse>(this.username,
                this.password, this.baseuri, "DailyScheduleWindowService", arg, this.timeoutSeconds);
        }
        ...
        public Task<ExportDailyScheduleWindowsListResponse> ExportDailyScheduleWindowsListAsync(
            ExportDailyScheduleWindowsList arg)
        {
            return Client.PostAsync<ExportDailyScheduleWindowsList, ExportDailyScheduleWindowsListResponse>(
                this.username, this.password, this.baseuri, "DailyScheduleWindowService", arg, this.timeoutSeconds);
        }
        ...
        {
            return Client.Post<ExportDailyScheduleWindows, ExportDailyScheduleWindowsResponse>(this.username,
                this.password, this.baseuri, "DailyScheduleWindowService", arg, this.timeoutSeconds);
        }
        ...
        public Task<ExportDailyScheduleWindowsResponse> ExportDailyScheduleWindowsAsync(
            ExportDailyScheduleWindows arg)
        {
            return Client.PostAsync<ExportDailyScheduleWindows, ExportDailyScheduleWindowsResponse>(this.username,
                this.password, this.baseuri, "DailyScheduleWindowService", arg, this.timeoutSeconds);
        }
    }
}