...
{
  [XmlType(Namespace = "http://echange.service.open.bodet.com", TypeName = "exportAnomalies")]
  public class ExportAnomalies
  {
    ...
    [XmlElement(DataType = "string", ElementName = "anomalyType", IsNullable = true, Order = 4)]
