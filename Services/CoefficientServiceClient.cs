...
namespace KelioSDK.Services
{
    public class CoefficientServiceClient
    {
        ...
        {
            return Client.Post<ImportCoefficients, ImportCoefficientsResponse>(this.username, this.password,
                this.baseuri, "CoefficientService", arg, this.timeoutSeconds);
        }

        public Task<ImportCoefficientsResponse> ImportCoefficientsAsync(
            ImportCoefficients arg)
        {
            return Client.PostAsync<ImportCoefficients, ImportCoefficientsResponse>(this.username, this.password,
                this.baseuri, "CoefficientService", arg, this.timeoutSeconds);
        }
        ...
        {
            return Client.Post<ExportCoefficients, ExportCoefficientsResponse>(this.username, this.password,
                this.baseuri, "CoefficientService", arg, this.timeoutSeconds);
        }
        ...
        public Task<ExportCoefficientsResponse> ExportCoefficientsAsync(
            ExportCoefficients arg)
        {
            return Client.PostAsync<ExportCoefficients, ExportCoefficientsResponse>(this.username, this.password,
                this.baseuri, "CoefficientService", arg, this.timeoutSeconds);
        }
    }
}