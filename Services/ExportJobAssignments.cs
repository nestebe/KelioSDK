...
{
  [XmlType(Namespace = "http://echange.service.open.bodet.com", TypeName = "exportJobAssignments")]
  public class ExportJobAssignments
  {
    ...
    [XmlElement(DataType = "string", ElementName = "calculationMode", IsNullable = true, Order = 4)]
