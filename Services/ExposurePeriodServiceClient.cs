...
namespace KelioSDK.Services
{
    public class ExposurePeriodServiceClient
    {
        ...
        {
            return Client.Post<ImportExposurePeriod, ImportExposurePeriodResponse>(this.username, this.password,
                this.baseuri, "ExposurePeriodService", arg, this.timeoutSeconds);
        }

        public Task<ImportExposurePeriodResponse> ImportExposurePeriodAsync(
            ImportExposurePeriod arg)
        {
            return Client.PostAsync<ImportExposurePeriod, ImportExposurePeriodResponse>(this.username, this.password,
                this.baseuri, "ExposurePeriodService", arg, this.timeoutSeconds);
        }
        ...
        {
            return Client.Post<ExportExposurePeriod, ExportExposurePeriodResponse>(this.username, this.password,
                this.baseuri, "ExposurePeriodService", arg, this.timeoutSeconds);
        }
        ...
        public Task<ExportExposurePeriodResponse> ExportExposurePeriodAsync(
            ExportExposurePeriod arg)
        {
            return Client.PostAsync<ExportExposurePeriod, ExportExposurePeriodResponse>(this.username, this.password,
                this.baseuri, "ExposurePeriodService", arg, this.timeoutSeconds);
        }
    }
}