...
namespace KelioSDK.Services
{
    public class LaborContractAssignmentServiceClient
    {
        ...
        {
            return Client.Post<ExportLaborContractAssignments, ExportLaborContractAssignmentsResponse>(this.username,
                this.password, this.baseuri, "LaborContractAssignmentService", arg, this.timeoutSeconds);
        }

        public Task<ExportLaborContractAssignmentsResponse> ExportLaborContractAssignmentsAsync(
            ExportLaborContractAssignments arg)
        {
            return Client.PostAsync<ExportLaborContractAssignments, ExportLaborContractAssignmentsResponse>(
                this.username, this.password, this.baseuri, "LaborContractAssignmentService", arg, this.timeoutSeconds);
        }

        public DeleteLaborContractAssignmentsResponse DeleteLaborContractAssignments(
            DeleteLaborContractAssignments arg)
        {
            return Client.Post<DeleteLaborContractAssignments, DeleteLaborContractAssignmentsResponse>(this.username,
                this.password, this.baseuri, "LaborContractAssignmentService", arg, this.timeoutSeconds);
        }
        ...
        public Task<DeleteLaborContractAssignmentsResponse> DeleteLaborContractAssignmentsAsync(
            DeleteLaborContractAssignments arg)
        {
            return Client.PostAsync<DeleteLaborContractAssignments, DeleteLaborContractAssignmentsResponse>(
                this.username, this.password, this.baseuri, "LaborContractAssignmentService", arg, this.timeoutSeconds);
        }
        ...
        {
            return Client.Post<ImportLaborContractAssignments, ImportLaborContractAssignmentsResponse>(this.username,
                this.password, this.baseuri, "LaborContractAssignmentService", arg, this.timeoutSeconds);
        }
        ...
        public Task<ImportLaborContractAssignmentsResponse> ImportLaborContractAssignmentsAsync(
            ImportLaborContractAssignments arg)
        {
            return Client.PostAsync<ImportLaborContractAssignments, ImportLaborContractAssignmentsResponse>(
                this.username, this.password, this.baseuri, "LaborContractAssignmentService", arg, this.timeoutSeconds);
        }
    }
}