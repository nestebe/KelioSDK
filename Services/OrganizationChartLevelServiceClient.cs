...
namespace KelioSDK.Services
{
    public class OrganizationChartLevelServiceClient
    {
        ...
        {
            return Client.Post<ImportOrganizationChartLevels, ImportOrganizationChartLevelsResponse>(this.username,
                this.password, this.baseuri, "OrganizationChartLevelService", arg, this.timeoutSeconds);
        }

        public Task<ImportOrganizationChartLevelsResponse> ImportOrganizationChartLevelsAsync(
            ImportOrganizationChartLevels arg)
        {
            return Client.PostAsync<ImportOrganizationChartLevels, ImportOrganizationChartLevelsResponse>(this.username,
                this.password, this.baseuri, "OrganizationChartLevelService", arg, this.timeoutSeconds);
        }
        ...
        {
            return Client.Post<ExportOrganizationChartLevels, ExportOrganizationChartLevelsResponse>(this.username,
                this.password, this.baseuri, "OrganizationChartLevelService", arg, this.timeoutSeconds);
        }
        ...
        public Task<ExportOrganizationChartLevelsResponse> ExportOrganizationChartLevelsAsync(
            ExportOrganizationChartLevels arg)
        {
            return Client.PostAsync<ExportOrganizationChartLevels, ExportOrganizationChartLevelsResponse>(this.username,
                this.password, this.baseuri, "OrganizationChartLevelService", arg, this.timeoutSeconds);
        }
        ...
        {
            return Client.Post<DeleteOrganizationChartLevels, DeleteOrganizationChartLevelsResponse>(this.username,
                this.password, this.baseuri, "OrganizationChartLevelService", arg, this.timeoutSeconds);
        }
        ...
        public Task<DeleteOrganizationChartLevelsResponse> DeleteOrganizationChartLevelsAsync(
            DeleteOrganizationChartLevels arg)
        {
            return Client.PostAsync<DeleteOrganizationChartLevels, DeleteOrganizationChartLevelsResponse>(this.username,
                this.password, this.baseuri, "OrganizationChartLevelService", arg, this.timeoutSeconds);
        }
    }
}