...
namespace KelioSDK.Services
{
    public class DailyCommentAssignmentServiceClient
    {
        ...
        {
            return Client.Post<ExportDailyCommentAssignmentsList, ExportDailyCommentAssignmentsListResponse>(
                this.username, this.password, this.baseuri, "DailyCommentAssignmentService", arg, this.timeoutSeconds);
        }

        public Task<ExportDailyCommentAssignmentsListResponse> ExportDailyCommentAssignmentsListAsync(
            ExportDailyCommentAssignmentsList arg)
        {
            return Client.PostAsync<ExportDailyCommentAssignmentsList, ExportDailyCommentAssignmentsListResponse>(
                this.username, this.password, this.baseuri, "DailyCommentAssignmentService", arg, this.timeoutSeconds);
        }
        ...
        {
            return Client.Post<DeleteDailyCommentAssignments, DeleteDailyCommentAssignmentsResponse>(this.username,
                this.password, this.baseuri, "DailyCommentAssignmentService", arg, this.timeoutSeconds);
        }

        public Task<DeleteDailyCommentAssignmentsResponse> DeleteDailyCommentAssignmentsAsync(
            DeleteDailyCommentAssignments arg)
        {
            return Client.PostAsync<DeleteDailyCommentAssignments, DeleteDailyCommentAssignmentsResponse>(this.username,
                this.password, this.baseuri, "DailyCommentAssignmentService", arg, this.timeoutSeconds);
        }
        ...
        {
            return Client.Post<ImportDailyCommentAssignments, ImportDailyCommentAssignmentsResponse>(this.username,
                this.password, this.baseuri, "DailyCommentAssignmentService", arg, this.timeoutSeconds);
        }
        ...
        public Task<ImportDailyCommentAssignmentsResponse> ImportDailyCommentAssignmentsAsync(
            ImportDailyCommentAssignments arg)
        {
            return Client.PostAsync<ImportDailyCommentAssignments, ImportDailyCommentAssignmentsResponse>(this.username,
                this.password, this.baseuri, "DailyCommentAssignmentService", arg, this.timeoutSeconds);
        }
    }
}