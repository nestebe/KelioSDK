...
namespace KelioSDK.Services
{
    public class HourlyContractAssignmentServiceClient
    {
        ...
        {
            return Client.Post<DeletedHourlyContractAssignments, DeletedHourlyContractAssignmentsResponse>(
                this.username, this.password, this.baseuri, "HourlyContractAssignmentService", arg,
                this.timeoutSeconds);
        }
        ...
        public Task<DeletedHourlyContractAssignmentsResponse> DeletedHourlyContractAssignmentsAsync(
            DeletedHourlyContractAssignments arg)
        {
            return Client.PostAsync<DeletedHourlyContractAssignments, DeletedHourlyContractAssignmentsResponse>(
                this.username, this.password, this.baseuri, "HourlyContractAssignmentService", arg,
                this.timeoutSeconds);
        }
        ...
        {
            return Client.Post<ExportHourlyContractAssignments, ExportHourlyContractAssignmentsResponse>(this.username,
                this.password, this.baseuri, "HourlyContractAssignmentService", arg, this.timeoutSeconds);
        }

        public Task<ExportHourlyContractAssignmentsResponse> ExportHourlyContractAssignmentsAsync(
            ExportHourlyContractAssignments arg)
        {
            return Client.PostAsync<ExportHourlyContractAssignments, ExportHourlyContractAssignmentsResponse>(
                this.username, this.password, this.baseuri, "HourlyContractAssignmentService", arg,
                this.timeoutSeconds);
        }
        ...
        {
            return Client.Post<ImportHourlyContractAssignments, ImportHourlyContractAssignmentsResponse>(this.username,
                this.password, this.baseuri, "HourlyContractAssignmentService", arg, this.timeoutSeconds);
        }
        ...
        public Task<ImportHourlyContractAssignmentsResponse> ImportHourlyContractAssignmentsAsync(
            ImportHourlyContractAssignments arg)
        {
            return Client.PostAsync<ImportHourlyContractAssignments, ImportHourlyContractAssignmentsResponse>(
                this.username, this.password, this.baseuri, "HourlyContractAssignmentService", arg,
                this.timeoutSeconds);
        }
    }
