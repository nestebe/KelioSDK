...
namespace KelioSDK.Services
{
  public class PreliminaryPlanningActionsServiceClient
  {
    ...
    {
      return Client.Post<ExportPreliminaryPlanningActionsService, ExportPreliminaryPlanningActionsServiceResponse>(this.username, this.password, this.baseuri, "PreliminaryPlanningActionsService", arg, this.timeoutSeconds);
    }

    public Task<ExportPreliminaryPlanningActionsServiceResponse> ExportPreliminaryPlanningActionsServiceAsync(
      ExportPreliminaryPlanningActionsService arg)
    {
      return Client.PostAsync<ExportPreliminaryPlanningActionsService, ExportPreliminaryPlanningActionsServiceResponse>(this.username, this.password, this.baseuri, "PreliminaryPlanningActionsService", arg, this.timeoutSeconds);
    }
  }
}
