...
namespace KelioSDK.Services
{
    public class CompensatoryLeaveLimitServiceClient
    {
        ...
        {
            return Client.Post<ImportCompensatoryLeaveLimits, ImportCompensatoryLeaveLimitsResponse>(this.username,
                this.password, this.baseuri, "CompensatoryLeaveLimitService", arg, this.timeoutSeconds);
        }

        public Task<ImportCompensatoryLeaveLimitsResponse> ImportCompensatoryLeaveLimitsAsync(
            ImportCompensatoryLeaveLimits arg)
        {
            return Client.PostAsync<ImportCompensatoryLeaveLimits, ImportCompensatoryLeaveLimitsResponse>(this.username,
                this.password, this.baseuri, "CompensatoryLeaveLimitService", arg, this.timeoutSeconds);
        }
        ...
        {
            return Client.Post<ExportCompensatoryLeaveLimits, ExportCompensatoryLeaveLimitsResponse>(this.username,
                this.password, this.baseuri, "CompensatoryLeaveLimitService", arg, this.timeoutSeconds);
        }
        ...
        public Task<ExportCompensatoryLeaveLimitsResponse> ExportCompensatoryLeaveLimitsAsync(
            ExportCompensatoryLeaveLimits arg)
        {
            return Client.PostAsync<ExportCompensatoryLeaveLimits, ExportCompensatoryLeaveLimitsResponse>(this.username,
                this.password, this.baseuri, "CompensatoryLeaveLimitService", arg, this.timeoutSeconds);
        }
    }
}