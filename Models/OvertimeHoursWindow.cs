...
// Type: KelioSDK.Models.OvertimeHoursWindow
...
{
  [XmlType(Namespace = "http://echange.service.open.bodet.com", TypeName = "OvertimeHoursWindow")]
  public class OvertimeHoursWindow : DailyScheduleWindow
  {
    [XmlElement(DataType = "boolean", ElementName = "OTAAvailable", IsNullable = true)]
    public bool? OTAAvailable { get; set; }
    ...
    [XmlElement(DataType = "double", ElementName = "maximumPaidTotal", IsNullable = true)]
    public double? MaximumPaidTotal { get; set; }

    [XmlElement(DataType = "double", ElementName = "minimumTime", IsNullable = true)]
    public double? MinimumTime { get; set; }

    [XmlElement(DataType = "double", ElementName = "minimumPaidTotal", IsNullable = true)]
    public double? MinimumPaidTotal { get; set; }
